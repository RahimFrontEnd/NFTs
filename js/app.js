    ...
    (() => {
        ...
        class MousePRLX {
            ...
            paralaxMouseInit(paralaxMouse) {
                let parallaxWidth = window.innerWidth;
                let parallaxHeight = window.innerHeight;
                ...
                paralaxMouse.forEach((el => {
                    ...
                    function setMouseParallaxStyle() {
                        ...
                        const rotateX = paramСoefficientY / 10 * (directionY * positionY / parallaxHeight - .5);
                        const rotateY = paramСoefficientX / 10 * (directionX * positionX / parallaxWidth - .5);
                        const rotateZ = paramСoefficientX / 10 * (directionX * positionX / 100);
                        const scale = 1 + Math.abs(directionX * positionX / parallaxWidth * .2);
                        const scaleZ = 1 + Math.abs(directionX * positionX / parallaxWidth * 10);
                        el.style.cssText = `\n\t\t\t\t\t transform:\n\t\t\t\t\t\t  translate3D(${directionX * positionX / (paramСoefficientX / 10)}%,${directionY * positionY / (paramСoefficientY / 10)}%,0)\n\t\t\t\t\t\t  rotateX(${rotateX}deg)\n\t\t\t\t\t\t  rotateY(${rotateY}deg)\n\t\t\t\t\t\t  rotateZ(${rotateZ}deg)\n\t\t\t\t\t\t  scale3D(${scale},${scale},${scaleZ})\n\t\t\t\t\t ;\n\t\t\t\t`;
        ...
        function initSliders() {
            if (document.querySelector(".history__slider")) new core(".history__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".history__arrow_left",
                    nextEl: ".history__arrow_right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: "auto",
            ...
            if (document.querySelector(".seller__slider")) new core(".seller__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".seller__arrow_left",
                    nextEl: ".seller__arrow_right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
